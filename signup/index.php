  ...
  <div class="container">
    <div class="form-wrapper">
      ...
      <div class="flex gap-1 mt-6 justify-center">
        <p class="text-neutral500">Already have an account?</p>
        <a class="link" href="/todo/login">Log in</a>
      </div>
    </div>
  </div>
    ...
    (function() {
      ...
      loginForm.addEventListener("submit", function(e) {
        ...
        if (shouldProceed) {
          ...
          fetch("http://localhost/todo/api/users.php", {
              method: 'POST',
              body: JSON.stringify({
                email,
                password
            ...
            .then(data => {
              if (data.success) {
                window.location.href = "/todo/todos/new.php?new_member=true"
              } else {
                alert(data.message)
              }
            })
